        ...
        <form action="{{ route('book.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control @error('isbn') is-invalid @enderror" type="text" id="isbn" name="isbn" value="{{ old('isbn') }}">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control @error('publication_year') is-invalid @enderror" type="number" id="publication_year" name="publication_year" value="{{ old('publication_year') }}">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div class="mt-2">
                        <img id="preview" src="" alt="Preview Cover" style="max-height: 150px;">
                    </div>
                </div>
